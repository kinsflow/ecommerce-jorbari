                    ...
                    <form id="searchForm" action="{{route("search")}}">
                        <div class="form-group mb-0">
                            <div class="input-group">
                                <input class="form-control" placeholder="Enter Search Result" type="text" name="search" style="height: 100%;"/>
                        ...
                        @if(sizeof($products) >= 1)
                            @foreach($products as $product)
                                <div class="col col-lg-4 col-md-4 col-sm-6 col-12 text-center"><img
                                        class="img-fluid product-image" src="{{asset("storage/$product->image")}}">
